// const { exists, mkdirs, readFile } = require('hexo-fs');
 ...
 */
  ...
  //   console.log("photo")
  //   // var $ = jquery()
  //   $.get("https://api.nasa.gov/planetary/apod?api_key=6KXGsZOzVPPksahfEsJ8R4L75El3uJw5NwMc9Bnq", function(data){
  //       console.log(data)

  //       var path = "/photo/nasa/index.md";   // filespec="C:/path/myfile.txt"
